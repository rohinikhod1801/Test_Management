...
class CategoryManagementTest {
	...
	public void testAddNewCategory() {
		...
		CategoryRequest result = categories.addNewCategory(category);
	...
	public void testGetAllCategory() {
		...
		List<CategoryResponse> result = categories.getAllCategory();
	...
	public void testGetCategoryById_Success() {
		...
		ResponseEntity<?> result = categories.getCategoryById(categoryId);
	...
	public void testUpdateCategory_Success() {
		...
		ResponseEntity<CategoryResponse> result = categories.updateCategory(categoryToUpdate);
	...
	public void testDeleteCategory_Success() {
		...
		Long categoryId = 1L;
		ResponseEntity<?> result = categories.deleteCategory(categoryId);
		assertEquals(HttpStatus.OK, result.getStatusCode());
	}
